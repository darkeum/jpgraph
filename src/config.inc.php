...
use Darkeum\JpGraph\Util\ErrMsgText;
...
if (\version_compare(\PHP_VERSION, MIN_PHPVERSION) < 0) {
    Darkeum\JpGraph\Util\JpGraphError::RaiseL(13, \PHP_VERSION, MIN_PHPVERSION);
...
if (!\function_exists('imagetypes') || !\function_exists('imagecreatefromstring')) {
    Darkeum\JpGraph\Util\JpGraphError::RaiseL(25001);
...
if (INSTALL_PHP_ERR_HANDLER) {
    \set_error_handler('\Darkeum\JpGraph\Util\Helper::phpErrorHandler');
}
...
if (isset($GLOBALS['php_errormsg']) && CATCH_PHPERRMSG && !\preg_match('/|Deprecated|/i', $GLOBALS['php_errormsg'])) {
    Darkeum\JpGraph\Util\JpGraphError::RaiseL(25004, $GLOBALS['php_errormsg']);
}
