...
namespace Darkeum\JpGraph\Graph;

require_once __DIR__ . '/../config.inc.php';

use Darkeum\JpGraph\Image;
use Darkeum\JpGraph\Plot;
use Darkeum\JpGraph\Text;
use Darkeum\JpGraph\Util;
...
class Graph
{
    ...
    public function __construct($aWidth = 300, $aHeight = 200, $aCachedName = '', $aTimeout = 0, $aInline = true)
    {
        ...
        if (!$this->isRunningClear) {
            ...
            $theme_class = '\Darkeum\JpGraph\Themes\\' . DEFAULT_THEME_CLASS;
